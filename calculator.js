function calAnswer() {
    var exp = document.getElementById("id1").value;
    var res = eval(exp);
  ...
  function delBack() {
    var ex = document.getElementById("id1").value;
    document.getElementById("id1").value = ex.slice(0, ex.length - 1);
  }
  
  function printName() {
    document.getElementById("id1").value = "";
    document.getElementById("output").innerHTML = "MHITS";
    setTimeout(offCalc, 1000);
  }
